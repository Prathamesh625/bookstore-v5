...
function Login() {
  ...
  const loginUrl = "https://bookapi-1.herokuapp.com/new/login";
  const registerUrl = "https://bookapi-1.herokuapp.com/new/data";
  const codeVerificationUrl =
    "https://bookapi-1.herokuapp.com/new/verification";
